    ...
    passport.use("signupStrategy", new LocalStrategy(
        ...
        async (req, username, password, done)=>{
            try {
                ...
                return done(null,userCreated)//En este punto passport completa el proceso 
            } catch (error) {
                return done(error)
            }
        }
    ...
    passport.use("githubLoginStrategy", new githubStrategy(
        ...
        async(accesstoken,refreshToken,profile,done)=>{
            try {
                ...
                //verificar si el usuario esta registrado en nuestra app
                ...
                if(!user){
                    ...
                    const userCreated = await usersService.save(newUser);
                    return done(null,userCreated)//En este punto passport completa el proceso de manera automatica
                } else {
                    return done(null,user)
                }
            } catch (error) {
